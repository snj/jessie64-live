conf:
	...
	lb config --mirror-bootstrap "http://ftp.riken.jp/Linux/debian/debian/"
	lb config --mirror-chroot "http://ftp.riken.jp/Linux/debian/debian/"
	lb config --mirror-binary "http://ftp.riken.jp/Linux/debian/debian/"
	lb config --mirror-chroot-security "http://security.debian.org"
	lb config --mirror-binary-security "http://security.debian.org"
	lb config --mirror-debian-installer "http://ftp.riken.jp/Linux/debian/debian/"
